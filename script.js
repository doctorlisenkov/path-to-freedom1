...
const VIEW_META = {
  ...
  'full-path': {
    ...
    subtitle: 'Последовательный путь через лекции, практики и медитации. Проходи этапы в своём темпе и возвращайся к важным моментам — так выстраивается внутренняя опора.',
    theme: 'theme-path'
  },
  meditations: {
    title: 'Медитации',
