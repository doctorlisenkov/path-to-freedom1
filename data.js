window.APP_DATA = {
  ...
  kind: 'hero',
  description: 'Последовательный путь, который помогает шаг за шагом разобраться в себе. Иди в своём ритме, возвращайся к важному и постепенно собирай себя в целостность.',
  cta: 'Открыть маршрут'
},
    {
      id: 'meditations',
