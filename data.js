window.APP_DATA = {
  ...
  phases: [
    ...
    },
    {
      ...
      description: 'Познай себя через тело, научись собой управлять.',
      status: 'available',
    ...
    },
    {
      ...
      description: 'Понимание чувств, запретов на эмоции, контакт с болью, гневом, радостью и грустью.',
      status: 'available',
    ...
    },
    {
      ...
      description: 'То что было скопированно из семьи, кто ты без этого?',
      status: 'available',
    ...
    },
    {
      ...
      description: 'Почему мы слипаемся, теряем себя и как возвращать границы, свободу и "агентность".',
      status: 'planned',
      topics: ['Зависимые отношения', 'Слияние', 'Границы', 'Страх отвержения', 'Выход из созависимости']
    },
    {
      id: 'phase-7',
      title: 'Этап 7. Кризис понимания себя',
    ...
    },
    {
      id: 'phase-8',
      title: 'Этап 8. Травма',
      description: 'Как психика останавливается в развитии и что с этим делать.',
      status: 'planned',
    ...
    },
    {
      ...
      description: 'Депрессии, что на них влияет.',
      status: 'planned',
